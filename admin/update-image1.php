...
<head>
	...
	<title>Admin| Actualizar Imagen del Producto</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 1 actual del producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva imagen 1 del producto</label>
<div class="controls">
