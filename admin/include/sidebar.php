...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Sub Categorías </a></li>
                                <li><a href="insert-product.php"><i class="menu-icon icon-paste"></i>Registrar Productos </a></li>
