...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 2 actual del producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva imagen 2 del producto</label>
<div class="controls">
