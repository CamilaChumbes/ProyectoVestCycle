...
$_SESSION['msg']="SubCategoría creada !!";
...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="SubCategoría eliminada !!";
		  }
...
<head>
	...
	<title>Admin| Sub Categorías</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de la Sub Categoría</label>
<div class="controls">
<input type="text" placeholder="Ingresa el nombre de la sub categoría"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Estas seguro que deseas eliminar la sub categoría?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
