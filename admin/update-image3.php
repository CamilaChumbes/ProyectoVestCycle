...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 3 actual del producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva imagen 3 del producto</label>
<div class="controls">
