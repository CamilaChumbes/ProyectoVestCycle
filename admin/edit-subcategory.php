...
<head>
	...
	<title>Admin| Editar Sub Categoría</title>
...
<div class="controls">
<input type="text" placeholder="Ingresa el nombre de la sub categoría"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
