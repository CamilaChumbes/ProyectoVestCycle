...
<head>
	...
	<title>Admin| Registrar Producto</title>
...
<div class="controls">
<input type="text"    name="productName"  placeholder="Ingresa el nombre del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingresa la marca del producto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto antes del descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingresa el precio del producto" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto después del descuento (precio de venta)</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingresa el precio del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Ingresa la descripción del producto" rows="6" class="span8 tip">
</textarea>  
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingresa el costo de envío del producto" class="span8 tip" required>
</div>
</div>
