...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Producto eliminado !!";
		  }
...
?>									
										<tr>
											...
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Estas seguro que deseas eliminar el producto?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
